 ...
 */
#ifndef	_DIOSCURI_TIMER_H
#define	_DIOSCURI_TIMER_H
 ...
 */
#ifdef CONFIG_MMU
#define CKTIMER_BASE          KSEG1ADDR(DIOSCURI_TIMER_PHYS)
#else
#define CKTIMER_BASE          DIOSCURI_TIMER_PHYS
#endif
