/*
 * linux/arch/csky/include/asm/pgtable-nommu.h
 *
 * This file is subject to the terms and conditions of the GNU General Public
 * License.  See the file "COPYING" in the main directory of this archive
 * for more details.
 *
 * Copyright (C) 2011  Hangzhou C-SKY Microsystemsi,.Ltd
 * Copyright (C) 2011  Dou Shaobin (shaobin_dou@c-sky.com)
 */

#ifndef _ASM_PGTABLE_NOMMU_H
#define _ASM_PGTABLE_NOMMU_H
