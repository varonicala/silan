...
#define     CSKY_LCDTIM0_PPL_320        19 << 4  // pixels-per-line = 16 * (19 + 1)

#define     CSKY_LCDTIM1_EFW_2          2 << 16
#define     CSKY_LCDTIM1_VSW_2          2 << 10
#define     CSKY_LCDTIM1_LPP_240        239      // Lines per panel = 239 + 1 

#define     CSKY_LCDTIM2_PCD_20         4        //pixel clock divisor = 2 * ( + 1)
...
/* GPIO configure for LCD */
//Interface mode
#define CSKY_SYNC_MODE           0x409d
#define CSKY_DE_MODE             0x609d
#define CSKY_RGB_RGB             0x204

// H/V Sync Backporch
#define CSKY_HLW             0x12
#define CSKY_HBP             0x18
#define CSKY_HFP             0x18
#define CSKY_VLW             0x04
#define CSKY_VBP             0x04
#define CSKY_VFP             0x05

//use GPA for LCD input
#define CSKY_R_GPADAT     CK_GPIO_BASE 

#define CSKY_GPA1         CK_GPIO_P1   
#define CSKY_GPA2         CK_GPIO_P2
#define CSKY_GPA3         CK_GPIO_P3

#define LCDCS_L    *CSKY_R_GPADAT &=~ CSKY_GPA1      
#define LCDSCL_L   *CSKY_R_GPADAT &=~ CSKY_GPA2
#define LCDSDI_L   *CSKY_R_GPADAT &=~ CSKY_GPA3

#define LCDCS_H    *CSKY_R_GPADAT |=  CSKY_GPA1
#define LCDSCL_H   *CSKY_R_GPADAT |=  CSKY_GPA2 
#define LCDSDI_H   *CSKY_R_GPADAT |=  CSKY_GPA3

#define GPIOA_DATA_CONFIG    (CSKY_GPA1 | CSKY_GPA2 | CSKY_GPA3)
