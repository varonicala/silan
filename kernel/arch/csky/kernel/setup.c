...
static char __initdata default_command_line[COMMAND_LINE_SIZE] = CONFIG_CMDLINE;
...
{
	return &(default_command_line[0]);
}

void __init setup_arch(char **cmdline_p)
{
	extern void plat_chip_setup(void);
...
static int show_cpuinfo(struct seq_file *m, void *v)
{
    ...
    if (n == 0)
	{
		...
		if (!machine_type || ('\0' == *machine_type))
			machine_type = "unknow!";
    ...
    /*
     * The fiducial operation declt + bf need 3 cycle. So calculate CPU clock 
     *  need to multiply 3.
     */
