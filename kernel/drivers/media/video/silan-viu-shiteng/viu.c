...
printk("scaleMode==SCALE_Y_1_2_C_1_2\n");
...
//change VI0 to VI2
	...
	printk("handle->frameInfo[0].Y_addr:%x\n",handle->frameInfo[0].Y_addr);
	...
	printk("handle->frameInfo[1].Y_addr:%x\n",handle->frameInfo[1].Y_addr);
...
static int VIU_Config_MODE_PROGRESSIVE_EMBBED_PORT0(VIU_handle_t *handle)
{
	...
	VI_PortCfg(1,MODE_PROGRESSIVE_EMBBED_PORT0_CFG_PORT0);
	VI_PortReset(1);
#if 1
	//port_clk_sel_div = 0x000002a8;
	port_clk_sel_div = 0x00084000;
	...
	VI_CHCfg(VI2_INT_EN, MODE_PROGRESSIVE_EMBBED_PORT0_INT_EN_CH0);
	VI_SetCHFifoDepth(2, MODE_PROGRESSIVE_EMBBED_PORT0_FIFO0_DEPTH_CH0, MODE_PROGRESSIVE_EMBBED_PORT0_FIFO1_DEPTH_CH0, MODE_PROGRESSIVE_EMBBED_PORT0_FIFO2_DEPTH_CH0);
