...
#define TOUCH_MAX_HEIGHT 	730			
#define TOUCH_MAX_WIDTH		550
...
#define SHUTDOWN_PORT 	   10 
#define INT_PORT 	       38 
#ifdef INT_PORT
	#define TS_INT 		        134			//Interrupt Number,EINT18(119)
	#define INT_CFG    	        3 					//IO configer as EINT
#else
	#define TS_INT	0
#endif	
